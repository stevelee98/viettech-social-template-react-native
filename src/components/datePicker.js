...
class DatePicker extends Component {
    ...
    getTitleElement() {
        const { date, placeholder, customStyles, allowFontScaling } =
            this.props;
    ...
    _renderIcon() {
        const { showIcon, iconSource, iconComponent, customStyles } =
            this.props;
                                        ...
                                        >
                                            ...
                                            >
                                                <DatePickerIOS
                                                    ...
                                                    minimumDate={
                                                        minDate &&
                                                        this.getDate(minDate)
                                                    }
                                                    maximumDate={
                                                        maxDate &&
                                                        this.getDate(maxDate)
                                                    }
                                                    onDateChange={
                                                        this.onDateChange
                                                    }
...
DatePicker.defaultProps = {
    ...
    confirmBtnText: '确定',
    cancelBtnText: '取消',
    iconSource: require('images/ic_date.png'),
    customStyles: {},
